...
class ComplexConvTranspose1d(Module):
    def __init__(
        ...
        self.conv_tran_r = ConvTranspose1d(
            in_channels,
            out_channels,
            kernel_size,
            stride,
        ...
        self.conv_tran_i = ConvTranspose1d(
            in_channels,
            out_channels,
            kernel_size,
            stride,
    ...
    def forward(self, input_r, input_i):
        return (
            self.conv_tran_r(input_r) - self.conv_tran_i(input_i),
...
class ComplexConv1d(Module):
    ...
    def forward(self, input_r, input_i):
        return (
            self.conv_r(input_r) - self.conv_i(input_i),
...
class ComplexLinear(Module):
    ...
    def forward(self, input_r, input_i):
        return (
            self.fc_r(input_r) - self.fc_i(input_i),
...
class ComplexBatchNorm2d(_ComplexBatchNorm):
    def forward(self, input_r, input_i):
        ...
        if self.training:
            ...
            Crr = 1.0 / n * input_r.pow(2).sum(dim=[0, 2, 3]) + self.eps
            Cii = 1.0 / n * input_i.pow(2).sum(dim=[0, 2, 3]) + self.eps
...
class ComplexBatchNorm1d(_ComplexBatchNorm):
    def forward(self, input_r, input_i):
        ...
        input_r, input_i = (
            Rrr[None, :] * input_r + Rri[None, :] * input_i,
            Rii[None, :] * input_i + Rri[None, :] * input_r,
        )

        if self.affine:
            input_r, input_i = (
                self.weight[None, :, 0] * input_r
                + self.weight[None, :, 2] * input_i
                + self.bias[None, :, 0],
                self.weight[None, :, 2] * input_r
                + self.weight[None, :, 1] * input_i
                + self.bias[None, :, 1],
            )
